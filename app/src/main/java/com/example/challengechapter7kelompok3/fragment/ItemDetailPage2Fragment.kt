...
class ItemDetailPage2Fragment : Fragment(), ItemDetailActivity.OnSendDataToFragment {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_item_detail_page2, container, false)
